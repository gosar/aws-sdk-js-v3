...
export class TestPayloadStructureHandler<Context> implements __ServiceHandler<Context> {
  private readonly operation: __Operation<TestPayloadStructureServerInput, TestPayloadStructureServerOutput, Context>;
  private readonly mux: __Mux<"RestJson", "TestPayloadStructure">;
  private readonly serializer: __OperationSerializer<
    RestJsonService<Context>,
    "TestPayloadStructure",
    TestPayloadStructureErrors
  >;
  ...
  /**
   * Construct a TestPayloadStructure handler.
   * @param operation The {@link __Operation} implementation that supplies the business logic for TestPayloadStructure
   * @param mux The {@link __Mux} that verifies which service and operation are being invoked by a given {@link __HttpRequest}
   * @param serializer An {@link __OperationSerializer} for TestPayloadStructure that
