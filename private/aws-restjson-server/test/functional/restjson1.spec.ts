 ...
 */
it("RestJsonBodyBooleanStringCoercion_case0:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * Attempted string coercion should result in SerializationException
 */
it("RestJsonBodyBooleanStringCoercion_case1:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * Attempted string coercion should result in SerializationException
 */
it("RestJsonBodyBooleanStringCoercion_case2:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * Attempted string coercion should result in SerializationException
 */
it("RestJsonBodyBooleanStringCoercion_case12:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * Attempted string coercion should result in SerializationException
 */
it("RestJsonBodyBooleanStringCoercion_case13:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * Attempted string coercion should result in SerializationException
 */
it("RestJsonBodyBooleanStringCoercion_case14:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * YAML-style alternate boolean literals should result in SerializationException
 */
it("RestJsonBodyBooleanBadLiteral_case7:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * YAML-style alternate boolean literals should result in SerializationException
 */
it("RestJsonBodyBooleanBadLiteral_case18:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * 400 SerializationException
 */
it("RestJsonBodyTimestampDefaultRejectsDateTime_case0:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * 400 SerializationException
 */
it("RestJsonBodyTimestampDefaultRejectsDateTime_case1:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * 400 SerializationException
 */
it("RestJsonBodyTimestampDefaultRejectsDateTime_case2:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * 400 SerializationException
 */
it("RestJsonBodyTimestampDefaultRejectsStringifiedEpochSeconds_case0:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
 ...
 * 400 SerializationException
 */
it("RestJsonBodyTimestampDefaultRejectsStringifiedEpochSeconds_case1:MalformedRequest", async () => {
  const testFunction = jest.fn();
  testFunction.mockImplementation(() => {
    throw new Error("This request should have been rejected.");
  });
...
it("RestJsonPathTimestampDefaultRejectsDifferent8601Formats_case13:MalformedRequest", async () => {
  ...
  const request = new HttpRequest({
    method: "POST",
    hostname: "foo.example.com",
    path: "/MalformedTimestampPathDefault/1996-12-19 16%3A39%3A57Z",
    query: {},
    headers: {},
  });
  const r = await handler.handle(request, {});
